...
public class PrescriptionEditingActivity extends AppCompatActivity {
    ...
    private boolean validatePrescription() {
        if (prescriptionDrugList.isEmpty()){
            Toast.makeText(PrescriptionEditingActivity.this, "No drugs in the prescription", Toast.LENGTH_LONG).show();
            return false;
        }
        ...
        ItemTouchHelper.SimpleCallback simpleCallback = new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
            ...
            public void onSwiped(final RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                if (direction == ItemTouchHelper.LEFT) {    //if swipe left
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(PrescriptionEditingActivity.this); //alert for confirm to delete
    ...
    private void confirmPrescription() {
        ...
        Callback<DataWriteResponse> confirmPressResponse = new Callback<DataWriteResponse>() {
            ...
            public void onResponse(Call<DataWriteResponse> call, Response<DataWriteResponse> response) {
                ...
                if (response.isSuccessful()) {
                    if (responseObject.isSuccess()) {
                        ...
                        progress_bar_confirm.setVisibility(View.GONE);
                        Toast.makeText(PrescriptionEditingActivity.this, "Error saving prescription. Tey Again.", Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<DataWriteResponse> call, Throwable t) {
                progress_bar_confirm.setVisibility(View.GONE);
                Toast.makeText(PrescriptionEditingActivity.this, Common.ERROR_NETWORK, Toast.LENGTH_LONG).show();
                btn_confirm_prescription.setVisibility(View.VISIBLE);
            }
        };
