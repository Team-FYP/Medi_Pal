...
public class PatientSelfInfoRecyclerAdaptor extends Adapter<PatientSelfInfoRecyclerAdaptor.RecyclerViewHolder>{
    private Patient patient;

    public PatientSelfInfoRecyclerAdaptor(Patient patient) {
        this.patient = patient;
    }

    @Override
    public PatientSelfInfoRecyclerAdaptor.RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_patient_basic_information, parent, false);
        PatientSelfInfoRecyclerAdaptor.RecyclerViewHolder recyclerViewHolder = new PatientSelfInfoRecyclerAdaptor.RecyclerViewHolder(view);
